...
// **************************************GENERAL*************************************
     ...
     *	constantes.courant.TB2D_CURL (ou + "_CU")
     *  constantes.courant.TB2D_DIV  (ou + "_CU")
     *  constantes.courant.TB2D_EST_OUEST
     *  constantes.courant.TB2D_NORD_SUD
     *  constantes.courant.TB2D_NORME
     *	ou
     *	constantes.centre.AFF_RIEN : couleur unie ou image !
     */
    static final int DEFAULT_AFFICHE_EN_FOND = constants.courant.TB2D_CURL;
    
    /** indique quelle est la donn�es dont on cherche les zones de concentration
	 *parmis :
	 * constantes.physique.DIV
	 * constantes.physique.DIV_CU
	 * constantes.physique.CURL
	 * constantes.physique.CURL_CU  */
	static final int DEFAULT_ZONE_CONCENTRATION = constants.physique.CURL;
	...
	/** QUELS EXTREMA MONTRER ? */
      ...
      *parmis
      * constantes.couleur.NOIR_BLANC_NOIR
	  * constantes.couleur.BLEU_BLANC_NOIR
	  *	constantes.couleur.BLEU_BLANC_VERT
	  *	constantes.couleur.ROUGE_BLANC_BLEU
	  */
     static final int TYPE_DEGRADE = constants.couleur.BLEU_GRIS_NOIR;
