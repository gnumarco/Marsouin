...
public interface Centre extends DefaultValues {
    ...
    public static final int AFF_RIEN = 0;
	    ...
	    static final int AFF_CURL = Stream.TB2D_CURL;
	    static final int AFF_DIV = Stream.TB2D_DIV;
	    static final int AFF_CURL_CU = Stream.TB2D_CURL_CU;
	    static final int AFF_DIV_CU = Stream.TB2D_DIV_CU;
	// fond
    static final int AFF_EST_OUEST = Stream.TB2D_EST_OUEST;
    static final int AFF_NORD_SUD = Stream.TB2D_NORD_SUD;
    static final int AFF_NORME = Stream.TB2D_NORME;
    ...
    // somme des vecteurs de Stream
    static final int VECTEURS=0;
    // somme des vecteurs unitaires de Stream
    ...
    // facteur multiplicatif qui determine l'importance accordee au Stream du point central
