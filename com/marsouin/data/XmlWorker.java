...
public class XmlWorker extends DefaultHandler {
    ...
    public void startDocument() throws SAXException {
        log.info("Starting config file analysis");
    }
    ...
    public void endDocument() throws SAXException {
        log.info("Ending config file analysis");
    }

    @Override
    public void startPrefixMapping(String prefix, String URI) throws SAXException {
        log.info("Traitement de l'espace de nommage : " + URI + ", prefixe choisi : " + prefix);
    }

    @Override
    public void endPrefixMapping(String prefix) throws SAXException {
        log.info("Fin de traitement de l'espace de nommage : " + prefix);
    }
    ...
    public void startElement(String nameSpaceURI, String localName, String rawName, Attributes attributs) throws SAXException {
        ...
        if (!"".equals(nameSpaceURI)) { // espace de nommage particulier
            log.info("  appartenant a l'espace de nom : " + nameSpaceURI);
        }

        //System.out.println("  Attributs de la balise : ");
        for (int index = 0; index < attributs.getLength(); index++) { // on parcourt la liste des attributs
            log.info("     - " + attributs.getLocalName(index) + " = " + attributs.getValue(index));
    ...
    public void endElement(String nameSpaceURI, String localName, String rawName) throws SAXException {
        ...
        if (!"".equals(nameSpaceURI)) { // name space non null
            log.info("appartenant a l'espace de nommage : " + localName);
        }
    }
    ...
    public void characters(char[] ch, int start, int end) throws SAXException {
        log.info("#PCDATA : " + new String(ch, start, end));
    }
    ...
    public void ignorableWhitespace(char[] ch, int start, int end) throws SAXException {
        log.info("espaces inutiles rencontres : ..." + new String(ch, start, end) + "...");
    }
     ...
     * @param data les valeurs associees a cette cible. En general, elle se
    ...
    public void processingInstruction(String target, String data) throws SAXException {
        log.info("Instruction de fonctionnement : " + target);
        log.info("  dont les arguments sont : " + data);
    }
