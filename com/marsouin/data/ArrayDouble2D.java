...
public class ArrayDouble2D implements com.marsouin.constants.Stream {
     ...
     */
    public ArrayDouble2D(int taille_ini_i, int taille_ini_j) {
     ...
     */
    public ArrayDouble2D cloneMe() {
        ArrayDouble2D ret = new ArrayDouble2D(tab.length, tab[0].length);
...
/*    public void getListeExtremaDans(ArrayList min, ArrayList max) {
    ...
    public void savetab(String s) {
        ArrayDouble2DResultatFile r = new ArrayDouble2DResultatFile(s);
        r.sauver(tab);
    }
