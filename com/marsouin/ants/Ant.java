...
public class Ant implements com.marsouin.constants.Ant, com.marsouin.constants.Stream{
     ...
     * @param c Le moteur de recherche auquel est ratach�e la Ant
     * @param b Le biais de la Ant dans le choix de sa trajectoire (compris entre -1 et 1)
     * @param x Position initiale de la Ant sur l'axe des X.
     * @param y Position initiale de la Ant sur l'axe des Y.
     * @param esp Num�ro de l'esp�ce � laquelle appartient la Ant.
     * @param ident Num�ro de la Ant dans son esp�ce.
     * @param dep Quantit� de ph�romone d�pos�e par la Ant lors d'une g�n�ration.
     */
    ...
    /** M�thode permettant faire �voluer la Ant d'une g�n�ration. */    
    public void move(){
