...
import es.gpc.gp.ec.coevolve.GroupedProblemForm;
import es.gpc.gp.ec.simple.SimpleProblemForm;
import es.gpc.gp.ec.simple.SimpleEvolutionState;
        ...
        for (x = 0; x < args.length - 1; x++)
            if (args[x].equals(A_FILE))
                ...
                try
                    ...
                    parameters.set(new Parameter(es.gpc.gp.ec.EvolutionState.P_EVALUATOR).push(es.gpc.gp.ec.Evaluator.P_IAMSLAVE), "true");
                    break;
                    }
            ...
            try
                ...
                try
                    ...
                    state = (EvolutionState)
                        parameters.getInstanceForParameter(new Parameter(es.gpc.gp.ec.Evolve.P_STATE),null,
