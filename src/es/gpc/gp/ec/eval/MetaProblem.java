...
import es.gpc.gp.ec.vector.FloatVectorSpecies;
import es.gpc.gp.ec.vector.DoubleVectorIndividual;
import es.gpc.gp.ec.util.Parameter;
import es.gpc.gp.ec.util.MersenneTwisterFast;
import es.gpc.gp.ec.util.ParameterDatabase;
import es.gpc.gp.ec.util.DataPipe;
import es.gpc.gp.ec.util.Output;
import es.gpc.gp.ec.simple.SimpleStatistics;
import es.gpc.gp.ec.simple.SimpleProblemForm;
import es.gpc.gp.ec.simple.SimpleShortStatistics;
    ...
    */
    ...
    public void evaluate(EvolutionState state,
        ...
        for(int run = 0; run < runs; run++)
            ...
            out.addLog(es.gpc.gp.ec.util.Log.D_STDOUT,false);
            out.addLog(es.gpc.gp.ec.util.Log.D_STDERR,true);
