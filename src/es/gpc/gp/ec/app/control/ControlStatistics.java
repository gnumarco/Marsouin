...
import es.gpc.gp.ec.steadystate.SteadyStateStatisticsForm;
...
import es.gpc.gp.ec.Statistics;
 ...
 * @version 1.0 
 */
public class ControlStatistics extends Statistics implements SteadyStateStatisticsForm //, ec.eval.ProvidesBestSoFar
{
        ...
        try {
            ...
            for (int x = 0; x < state.population.subpops.length; x++) {
                ...
                for (int y = 1; y < state.population.subpops[x].individuals.length; y++) {
                    bw.write(((GPIndividual) state.population.subpops[x].individuals[y]).trees[0].child.makeCTree(true, true, true) + "\n");
