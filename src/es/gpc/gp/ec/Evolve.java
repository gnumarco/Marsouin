...
import es.gpc.gp.ec.util.Version;
 ...
 *
 * <p>
 * <tt>java ec.Evolve -file </tt><i>parameter_file [</i><tt>-p
 * </tt><i>parameter=value]*</i>
 *
 * <p>
 ...
 * <tt>time</tt>, then the seed is based on the system clock plus
 * <i>n</i>.)</td></tr>
 *
 ...
 * parameters requested during the run?)</td></tr>
 *
 * <tr><td valign=top><tt>print-used-params</tt><br>
 * <font size=-1>bool = <tt>true</tt> or <tt>false</tt> (default)</td>
 * <td valign=top>(at the end of a run, do we print out a list of all the
 * parameters actually <i>used</i> during the run?)</td></tr>
 *
 * <tr><td valign=top><tt>print-unaccessed-params</tt><br>
 * <font size=-1>bool = <tt>true</tt> or <tt>false</tt> (default)</td>
 * <td valign=top>(at the end of a run, do we print out a list of all the
 * parameters NOT requested during the run?)</td></tr>
 *
 * <tr><td valign=top><tt>print-unused-params</tt><br>
 * <font size=-1>bool = <tt>true</tt> or <tt>false</tt> (default)</td>
 * <td valign=top>(at the end of a run, do we print out a list of all the
 * parameters NOT actually used during the run?)</td></tr>
 *
 * <tr><td valign=top><tt>print-all-params</tt><br>
 * <font size=-1>bool = <tt>true</tt> or <tt>false</tt> (default)</td>
 * <td valign=top>(at the end of a run, do we print out a list of all the
 * parameters stored in the parameter database?)</td></tr>
 *
 * </table>
 *
 *
...
public class Evolve extends Thread {
    ...
    public static Output buildOutput() {
        ...
        // by default.
        output.addLog(es.gpc.gp.ec.util.Log.D_STDOUT, false);
        output.addLog(es.gpc.gp.ec.util.Log.D_STDERR, true);
     ...
     *
     * <p>
     * This method works by first setting up an Output (using buildOutput), then
     * calling initialize(ParameterDatabase, seed, output)
     *
     * @param parameters
     * @param randomSeedOffset
     * @return
     */
    ...
    public static EvolutionState initialize(ParameterDatabase parameters, int randomSeedOffset, Output output) {
        ...
        state = (EvolutionState) parameters.getInstanceForParameter(new Parameter(P_STATE), null,
    ...
    public void run() {
        ...
        glog.state = "Evolution terminated";
        //System.exit(0);
    }
}
